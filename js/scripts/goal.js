...
// https://spreadsheets.google.com/feeds/list/15t_UyCVhfBd7hebuJmbwD-sr67phcR3BdCi_SFinvKs/default/public/values?alt=json
 ...
 $.getJSON(url, function(data) {
  ...
  var monthlyUnits = entry['gsx$may2017units']['$t'];
  ...
  // Months
  var monthlyGoal = entry['gsx$may2017goal']['$t'];
  var monthlyGoalConverted = numeral(entry['gsx$may2017goal']['$t']).format('$0.0a');
  $('.monthly-goal').append(monthlyGoalConverted);

  var monthlyCurrent = entry['gsx$may2017actual']['$t'];
